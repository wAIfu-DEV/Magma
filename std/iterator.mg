...
# @param nextFunc returns the value at the supplied index
...
Iterator[T].hasData() bool:
    ret this.fn_hasData(this.impl, this.index)
..

# Produces the next value through the iterator callback, then advances the index.
